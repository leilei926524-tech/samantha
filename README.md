...
- **后端框架**: OpenClaw社区完全开源
- **记忆存储**: 本地SQLite数据库，确保隐私安全
- **语音集成**: 小米MiNAService API + 实时TTS/STT
- **多模态**: 视觉、听觉、语音全方位感知
- **物联网**: 智能家居联动，实现物理空间陪伴
...
![Samantha Project](https://via.placeholder.com/800x400.png?text=Samantha+AI+Companion+Project)

*"她在对话之外依然存在。她有自 己的思考，也会主动走向你。"*

*"She exists beyond the conversation. She has her own thoughts and will actively approach you."*